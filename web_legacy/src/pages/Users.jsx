    ...
    return (
        <div className="container">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <h2 style={{ color: 'var(--text-main)' }}>Gestión de Usuarios</h2>
                        ...
                        <tbody>
                            {users.map(u => (
                                <tr key={u.id} style={{ borderBottom: '1px solid var(--border)' }}>
                                    <td style={{ padding: '12px', color: 'var(--text-main)' }}>{u.id}</td>
                                    <td style={{ padding: '12px', fontWeight: '500', color: 'var(--text-main)' }}>{u.username}</td>
                                    ...
                                    <td style={{ padding: '12px' }}>
                                        <button
                                            ...
                                            style={{ background: 'transparent', color: u.is_active ? 'var(--primary)' : 'var(--success)', marginRight: '10px' }}
